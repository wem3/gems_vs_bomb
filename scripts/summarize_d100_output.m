...
writetable(t,[fullfile(cleanDataDir,'b1_d100_table.csv')]);
...
t = table(subID,gems,bomb,pGems,chose80,chose60,chose40,chose20,it,lr,sticky);
writetable(t,[fullfile(cleanDataDir,'b2_d100_table.csv')]);
...
writetable(t,[fullfile(cleanDataDir,'b3_d100_table.csv')]);
cabut studyDir cleanDataDir;
...
% writetable(t,[fullfile(cleanDataDir,'b4_d100_table.csv')]);
% cabut studyDir cleanDataDir;
...
% make table, write data to .csv for easy python import
t = table(subID,gems,bomb,igbias,pGems,wGems,chose80,chose60,chose40,chose20,it,lr,sticky);
writetable(t,[fullfile(cleanDataDir,'b5_d100_table.csv')]);
cabut studyDir cleanDataDir;
