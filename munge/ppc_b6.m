function [data] = ppc_b6(studyDir)
% PPC_B6.M %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Preprocess b6 data for model specification via mfit
%
% Raw data must first be cleaned by munge_raw_b6.Rmd
%
% USAGE: [data] = ppc_b6(studyDir)
%
% INPUT:
...
% read b6_demo.csv (created by munge_raw_b6.Rmd)
demo = readtable(fullfile(cleanDataDir,'b6_demo.csv'));
trial = readtable(fullfile(cleanDataDir,'b6_trial_data_R.csv'));
